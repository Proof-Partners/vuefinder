  ...
  <ModalLayout>
    <div class="vuefinder__message-modal__content">
      <div class="vuefinder__message-modal__icon-container">
        <svg xmlns="http://www.w3.org/2000/svg" class="vuefinder__message-modal__icon" fill="none" viewBox="0 0 24 24"
      ...
      <div class="vuefinder__message-modal__text">
        <h3 class="vuefinder__message-modal__title" id="modal-title">{{ app.modal.data.value.title ?? 'Title' }}</h3>
        <div class="vuefinder__message-modal__message">
          <p class="vuefinder__message-modal__description">{{ app.modal.data.value.message ?? 'Message' }}</p>
        </div>
      </div>
    </div>
